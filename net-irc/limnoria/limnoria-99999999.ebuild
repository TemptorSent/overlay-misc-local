...
EGIT_TICKET_REPO_URI="https://github.com/weaselp/ticketbot"

DESCRIPTION="Python based extensible IRC infobot and channel bot"
HOMEPAGE="https://supybot.aperio.fr/"
LICENSE="BSD"
SLOT="0"
IUSE="crypt ssl test ticket"
...
RDEPEND="
	...
	ticket? ( dev-python/beautifulsoup[${PYTHON_USEDEP}] )
	!net-irc/supybot
...
src_unpack() {
	...
	use ticket && git-r3_fetch "${EGIT_TICKET_REPO_URI}" HEAD && git-r3_checkout "${EGIT_TICKET_REPO_URI}" "${S}/plugins/Ticket"
